...
const applicants = [
  {
    ...
    baths: "4",
    prix: "600",
    img: require("../components/img/chambre3.jpg"),
    id: 0,
    favact: "",
  },
  {
    ...
    baths: "2",
    prix: "150",
    img: require("../components/img/chambre2.jpg"),
    id: 1,
  },
  {
  ...
  },
  {
    ...
    baths: "1",
    prix: "70",
    img: require("../components/img/chambre1.jpg"),
    id: 4,
  },
  {
    title: "bit dial 9hab",
            ...
            return (
              ...
              >
                ...
                <div className="p-2 border border-gray-100 rounded-md ">
                  ...
                  <div>
                    <Button className="bg-black w-[90%] my-5 ml-4 ">
                      Reserves
                    </Button>
                  </div>
                </div>
